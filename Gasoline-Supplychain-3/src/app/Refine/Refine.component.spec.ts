...
describe('RefineComponent', () => {
  ...
  let mockRefineService;
  let mockDataService

  beforeEach(async(() => {

    mockRefineService = sinon.createStubInstance(RefineService);
    mockRefineService.getAll.returns([]);
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        {provide: RefineService, useValue: mockRefineService },
